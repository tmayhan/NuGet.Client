...
namespace NuGet.Packaging.FuncTest
{
    ...
    public class TimestampProviderTests
    {
        ...
        [CIOnlyFact]
        public void TimestampData_WithValidInput_ReturnsTimestamp()
        {
            var logger = new TestLogger();
            var timestampProvider = new Rfc3161TimestampProvider(_testFixture.DefaultTrustedTimestampService.Url);
        ...
        [CIOnlyFact]
        public void TimestampData_WhenRequestNull_Throws()
        {
            var logger = new TestLogger();
            var timestampProvider = new Rfc3161TimestampProvider(_testFixture.DefaultTrustedTimestampService.Url);
        ...
        [CIOnlyFact]
        public void TimestampData_WhenLoggerNull_Throws()
        {
            var timestampProvider = new Rfc3161TimestampProvider(_testFixture.DefaultTrustedTimestampService.Url);
            var data = "Test data to be signed and timestamped";
        ...
        [CIOnlyFact]
        public void TimestampData_WhenCancelled_Throws()
        {
            var logger = new TestLogger();
            var timestampProvider = new Rfc3161TimestampProvider(_testFixture.DefaultTrustedTimestampService.Url);
            var data = "Test data to be signed and timestamped";
        ...
        [CIOnlyFact]
        public void TimestampData_WhenTimestampSigningCertificateRevoked_Throws()
        {
            var certificateAuthority = _testFixture.DefaultTrustedCertificateAuthority;
            ...
            using (_testFixture.TestServer.RegisterResponder(timestampService))
            {
                var logger = new TestLogger();
