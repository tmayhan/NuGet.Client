    ...
    public class MSBuildAPIUtility
    {
            ...
            LibraryDependency libraryDependency)
        {
            ...
            foreach (var packageReferenceItem in packageReferencesItems)
            {
                ...
                {
                    var includeFlags = LibraryIncludeFlagUtils.GetFlagString(libraryDependency.IncludeType).Replace(',', ';');
                ...
                {
                    var suppressParent = LibraryIncludeFlagUtils.GetFlagString(libraryDependency.SuppressParent).Replace(',', ';');
            ...
            LibraryDependency libraryDependency)
        {
            ...
            {
                var suppressParent = LibraryIncludeFlagUtils.GetFlagString(libraryDependency.SuppressParent).Replace(',', ';');
                item.AddMetadata(IncludeAssets, suppressParent, expressAsAttribute: false);
            }
